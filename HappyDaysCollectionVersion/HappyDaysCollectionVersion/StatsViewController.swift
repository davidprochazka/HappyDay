...
class StatsViewController: UIViewController, MFMailComposeViewControllerDelegate, UITableViewDataSource, UITableViewDelegate, NSFetchedResultsControllerDelegate {
    ...
    func configureCell(cell: UITableViewCell, atIndexPath indexPath: NSIndexPath) {
        let eventCell = cell as! StatisticsTableViewCell
        let fetchedEvent = self.fetchedResultsController.objectAtIndexPath(indexPath) as! Event
        // FIXME
        eventCell.teamNameLabel?.text = fetchedEvent.timeStamp?.description
        eventCell.lastSevenRatingLabel?.text = fetchedEvent.happiness?.description
    }
